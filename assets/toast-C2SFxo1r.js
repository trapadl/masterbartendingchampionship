let e;function c(){return e||(e=document.createElement("div"),e.className="fixed top-4 right-4 z-50 flex flex-col gap-2",document.body.appendChild(e)),e}function s(t,n="info",r=3e3){const a=c(),o=document.createElement("div");return o.className=`
